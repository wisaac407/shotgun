...
def mapSequencerPreview():
    ...
    kmi = km.keymap_items.new('sequencer.sample', 'SELECTMOUSE', 'PRESS')
...
def mapGraphEditor():
    ...
    kmi = km.keymap_items.new('view2d.pan', 'ACTIONMOUSE', 'PRESS')
...
def map3DView():
    ...
    kmi_props_setattr(kmi.properties, 'extend', False)
    kmi = km.keymap_items.new('view3d.select_border', 'EVT_TWEAK_L', 'ANY', shift=True, alt=True)
    kmi_props_setattr(kmi.properties, 'extend', True)
...
def mapAnimation():
    ...
    kmi = km.keymap_items.new('anim.previewrange_set', 'EVT_TWEAK_L', 'ANY')
    kmi.active = False
